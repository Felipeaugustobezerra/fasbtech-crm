...
describe("Contracts UI", () => {
  ...
  it("requires explicit confirmation before canceling a Contract", async () => {
    const user = userEvent.setup();
  ...
  it("requires explicit confirmation before deactivating a Template", async () => {
    const user = userEvent.setup();
